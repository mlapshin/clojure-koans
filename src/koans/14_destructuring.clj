...
(meditations
 ...
 (= "Rich Hickey aka The Clojurer aka Go Time aka Macro Killah"
    (let [[first-name last-name & aliases]
      ...
      (str (clojure.string/join " aka " (flatten [(str first-name " " last-name)
                                          aliases])))))
 ...
 (= "Test Testerson, 123 Test Lane, Testerville, TX"
    ((fn [[first-name last-name] {street :street-address city :city state :state}]
       (clojure.string/join ", " [(str first-name " " last-name) street city state]))
